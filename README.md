...
### Activities:
- **Vector Addition Example**: Implemented vector addition in both Python and CUDA to compare performance and applied basic optimizations (e.g., memory coalescing, kernel tuning) to enhance CUDA performance.
